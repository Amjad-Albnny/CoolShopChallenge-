...
import com.amjadalbnny.collshopchallenge.Interfaces.GetDataCompletion;
...
import com.amjadalbnny.collshopchallenge.utils.AESCrypt;
import com.amjadalbnny.collshopchallenge.utils.ResponseCode;
import com.amjadalbnny.collshopchallenge.retrofit.GetDataService;
import com.amjadalbnny.collshopchallenge.retrofit.RetrofitClientInstance;
...
public class ServerCallsManager {
    ...
    public void getAvatarUrl(String avatar, final GetAvatarUrlCompletion completion){
        ...
        GetDataService service = RetrofitClientInstance.getRetrofitInstance().create(GetDataService.class);
        Call<ResponseBody> call = service.getAvatarUrl("amjad.albnny",avatar);
